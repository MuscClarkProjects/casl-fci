...
datatable(f::AbstractString, separator='\t') = readtable("../data/$f", separator=separator)
...
casl = datatable("casl_longitudinal_baseline_11Dec2015.txt")
...
gm = datatable("casl_longitudinal_baseline+gm_11Dec2015.txt")
...
casl_av = datatable("casl_longitudinal_all_visits_8Dec2015.txt")
...
gm_av = datatable("casl_longitudinal_all_visits_with_GM_8Dec2015.txt")
